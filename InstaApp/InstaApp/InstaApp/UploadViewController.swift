...
class UploadViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @objc func chooseIamge() {
        ...
        let pickerChontroller = UIImagePickerController()
        pickerChontroller.delegate = self
        pickerChontroller.sourceType = .photoLibrary
        present(pickerChontroller,animated: true,completion: nil)
